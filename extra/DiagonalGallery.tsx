...
const ScrollColumn = ({
  ...
  const itemHeight = isDesktop ? 150 : 80;
  const itemWidth = isDesktop ? 180 : 110;
      ...
      >
        {images.map((src, index) => (
          <div
            ...
            className="flex-shrink-0 rounded-[15px] md:rounded-[20px] overflow-hidden shadow-xl relative group"
          >
            <img
              src={src}
...
const DiagonalGallery = ({ className, lane1, lane2 }: DiagonalGalleryProps) => {
  return (
    ...
    >
      <div className="flex gap-[0.8em] md:gap-[1em] transform rotate-[18deg] scale-[1.7] translate-x-[15%] origin-center overflow-visible">

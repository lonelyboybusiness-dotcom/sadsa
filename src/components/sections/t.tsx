    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                className="absolute top-[80px] md:top-[120px] left-0 w-full z-20 flex flex-col items-center justify-center px-4"
            >
                <h2
            ...
            <div className="absolute left-[5%] md:left-[8%] top-[160px] md:top-[22dvh] z-10 w-[90%] md:w-full max-w-[450px] md:max-w-[550px] flex flex-col gap-[60px] md:gap-[100px]">
                ...
                >
                    <div className="flex flex-col gap-[14px] md:gap-[18px]">
                        <input
                            ...
                            placeholder="Name"
                            required
                            className="font-display w-full bg-[rgba(255,255,255,0.25)] backdrop-blur-[12px] border border-[rgba(255,180,0,0.35)] rounded-[8px] px-[20px] h-[44px] md:h-[50px] text-[#333] placeholder:text-[#333]/40 focus:outline-none focus:border-[rgba(255,150,0,0.7)] focus:bg-[rgba(255,255,255,0.35)] focus:shadow-[0_0_12px_rgba(255,180,0,0.3)] transition-all duration-300 text-[14px] md:text-[16px]"
                            value={formData.name}
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="submit-btn font-display w-[85px] h-[28px] flex items-center justify-center bg-[rgba(255,190,0,0.22)] backdrop-blur-[12px] border border-[rgba(255,160,0,0.6)] text-black font-semibold rounded-[8px] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-[1.2px] text-[10px] shadow-sm"
                    >
                ...
                <div className="w-full pb-10 md:pb-20">
                    <div className="flex flex-col gap-[16px] md:gap-[20px] p-10 md:p-12 bg-[rgba(255,240,200,0.35)] backdrop-blur-[18px] border-none rounded-[24px] md:rounded-[32px] max-w-[600px] shadow-sm leading-[1.6]">
                        <div className="flex flex-col gap-[2px] group font-display">
                        ...
                        <div className="flex flex-col gap-[2px] group font-display">
                            ...
                            <span className="text-black hover:text-black focus:text-black active:text-black font-semibold text-[14px]">
            ...
            <motion.p
                ...
                className="font-display absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 text-black/90 text-[9px] md:text-[11px] uppercase tracking-[0.4em] whitespace-nowrap font-extrabold"
            >
